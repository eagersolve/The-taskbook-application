...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="row"> 
          <div class="col-8">
            <h2 class="text-center mb-5">Приложение-задачник</h2>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach ($tasks as $task) : ?>
                  <tr>
                    ...
                    <td><?php echo $task['task_completed'] ?></td> 
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
              <input type="text" class="form-control mb-3" name="login_admin" placeholder="Login*" required>
              <input type="password" class="form-control mb-3" name="password_admin" placeholder="Password*" required>
              </div>
